...
<div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 ms-0 pb-3 active" data-bs-toggle="pill" href="?divId=tab-1"></a>
                        ...
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 pb-3" data-bs-toggle="pill" href="<?php echo base_url('index.php/Liste/liste/#tab-2')?>">
                        ...
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill" href="<?php echo base_url('index.php/Liste/liste/#tab-3')?>">
    ...
    <script>
    var divId = window.location.search.substring(1).split('=')[1]; // Récupérer la valeur du paramètre divId

    var link = document.querySelector('a[data-bs-toggle="pill"]'); // Sélectionner le lien

    if (divId && link) {
        link.href = '#' + divId; // Mettre à jour l'attribut href avec l'ID de la div
    }
   </script>
