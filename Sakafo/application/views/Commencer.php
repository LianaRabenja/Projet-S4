...
<nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" data-spy="affix" data-offset-top="10">
    ...
    <div class="radio-center">
        <form method="get" action="">
            <br><br><p style="Font-size: 30px;"><input type="radio" name="info"  checked=true value="0" name="" id="">Perdre poids</p>
            <br><p style="Font-size: 30px;"><input type="radio" name="info" value="1" id="">Augmenter de poids</p>
