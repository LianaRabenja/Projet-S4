        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="mb-5">Insert a new Regime</h1>
                </div>
                <div class="row g-4">
                    <div class="col-md-6 offset-md-3">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form action="<?php echo base_url('index.php/BackController/insertionRegime');?>" methode="get">
                                <div class="row g-3">
                                    <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-floating">
                                            <h3 class="mb-5">Dish in regime</h3>
                                                <?php for($i=0; $i<10; $i++){?>
                                                    <p><input type="checkbox" id="name" placeholder="name"> : Plat</p>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-floating">
                                            <h3 class="mb-5">Sport in regime</h3>
                                                <?php for($i=0; $i<10; $i++){?>
                                                    <p><input type="checkbox" id="name" placeholder="name"> : Plat</p>
                                                <?php } ?>
                                            </div>
