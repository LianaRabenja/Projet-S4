        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="mb-5">Insert a new Sport</h1>
                </div>
                <div class="row g-4">
                    <div class="col-md-6 offset-md-3">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form action="<?php echo base_url('index.php/BackController/insertionSport');?>" methode="get">
                                <div class="row g-3">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="duration" placeholder="duration" name="duree">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            ...
                                            <label for="weigth">Weigth get or lose (g)</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
